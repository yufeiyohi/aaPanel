...
wget -O "/root/LinuxPanel_EN-6.8.23.zip" "https://proxy.mshushu.com.cn/github.com/AaronYES/aapanel/releases/download/1.0/LinuxPanel_EN-6.8.23.zip"
red "下载完成,正在降级."
unzip LinuxPanel_EN-6.8.23.zip
cd /root/panel
wget -O "/root/panel/downgrade.sh" "https://proxy.mshushu.com.cn/raw.githubusercontent.com/yufeiyohi/aapanel/main/script/downgrade.sh"
...
wget -O "/root/LinuxPanel-7.7.0.zip" "https://proxy.mshushu.com.cn/github.com/AaronYES/aaPanel/releases/download/1.3/LinuxPanel-7.7.0.zip"
blue "下载完成,正在降级."
...
wget https://proxy.mshushu.com.cn/raw.githubusercontent.com/yufeiyohi/aaPanel/main/resource/repair.json
chattr +i /www/server/panel/data/repair.json
red "开心成功."
}
...
wget -O /root/chinese.zip https://proxy.mshushu.com.cn/github.com/AaronYES/aaPanel/releases/download/1.2/aapanel_chinese-6.8.21.zip
